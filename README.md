...
接手维护者或新的 Codex 请先阅读 [`AGENTS.md`](./AGENTS.md) 与 [`docs/codex-handoff.md`](./docs/codex-handoff.md)。
...
> 截至 2026-08-02，已验收的应用源码基线为 `0390775`（合并 PR #38 与 PR #39），合并态 CI run `30734009302` 成功。后续纯文档提交可能让 `main` 继续前进，接手时应实时核对 `origin/main`；请勿把“本地 MOCK 可运行”、“Docker/CI 已验证”与“生产已验收”视为同一状态。
